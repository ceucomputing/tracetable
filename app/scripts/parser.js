parser = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c50 = function(left, op, right) { return { "title": l["title"] + " " + op + " " + r["title"], "code": l["code"] + op + r["code"] }; },
        peg$c51 = "(",
        peg$c52 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c53 = ")",
        peg$c54 = { type: "literal", value: ")", description: "\")\"" },
        peg$c55 = function(additive) { return { "title": "(" + additive["title"] + ")", "code": "(" + additive["code"] + ")" }; },
        peg$c56 = { type: "other", description: "integer" },
        peg$c57 = /^[0-9]/,
        peg$c58 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c59 = function(digits) { return { "title": digits.join(""), "code": digits.join("") }; },
        peg$c60 = function(i) { return "label_" + i; },
        peg$c61 = function(v) { vars[v] = true; return { "title": v, "code":"tracetable_scope[\"" + v + "\"]" }; },
        peg$c62 = /^[a-zA-Z]/,
        peg$c63 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
        peg$c64 = function(letters) { return letters.join(""); },
